...
public class MusicPlayer : MonoBehaviour
{
    ...
    {
        GameObject otherAudioSource = GameObject.FindGameObjectWithTag("AudioSource");
        if (otherAudioSource != null)
        {
            AudioSource otherAudioSound = otherAudioSource.GetComponent<AudioSource>();
        }
    ...
    public void PlayAudioClipAtTime(float time)
    {
        ...
        GameObject otherAudioSource = GameObject.FindGameObjectWithTag("AudioSource");
        AudioSource otherAudioSound = otherAudioSource.GetComponent<AudioSource>();
        if (otherAudioSound != null)
        {
            otherAudioSound.mute = true;
        }
    }
